...
class IBClient:
    ...
    def connect(self):
        ...
        print(f'Connection to IBKR failed')
...
class OrderManager:
    ...
    def stock_market_order(self, symbol: str, quantity: float, exchange='SMART', currency='USD'):
        ...
        print(f'{quantity} Shares Market Order Placed on {symbol}')
        return trade
    ...
    def stock_limit_order(self, symbol: str, limitPrice: float, quantity: float, exchange='SMART', currency='USD'):
        ...
        print(f'{quantity} Shares Limit Order Placed on {symbol} on ${limitPrice}')
        return trade
